package com.uco.graduationproject.burstcar.architecture;
...
class ArchitectureCleanTest {

    JavaClasses javaClasses = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_ARCHIVES)
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_JARS)
            .importPackages("com.uco.graduationproject.burstcar");
    ...
    void domainDependsOnlyJava(){
        classes()
                ...
                .resideInAnyPackage("java..", "lombok..", "com.uco.graduationproject.burstcar.domain..")
                .check(javaClasses);
    }
